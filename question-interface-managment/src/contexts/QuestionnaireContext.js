...
const QuestionnaireContextProvider = (props) => {
  const [questions, dispatch] = useReducer(questionnaireReducer, [
    {id: 'v100', type: "range", title: "Hello BOI", labels: ["option 1", "option 222", "option 3", "option 4"]},
    {id: 'v1', type: "radio", title: "Hello Kitty", labels: ["option 1", "option 222", "option 3", "option 4"]},
    {id: 'v2', type: "checkbox", title: "untitled checkbox", labels: ["option 1", "option 2", "option 3", "option 4"]},
    {
