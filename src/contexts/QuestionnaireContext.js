...
const QuestionnaireContextProvider = (props) => {
  const [questions, dispatch] = useReducer(questionnaireReducer, [
    ...
    {id: 'v5', type: "raw", content:"<p class=\"flow-text\">Hier staat een demo vragenlijst voor u klaar. Dit staat in een RAW tag</p>"},
    {id: "v26", type: "dropdown", title: "dropdown", label: "Hey", tooltip: "Bye", options: ["option 1", "option 2", "option 3", "option 4"]},
    {id: "v32", type: "radio", shows_otherwise: "false", title: "Voorbeeld van een radio", options: [{title: "Ja", shows_question: ["v2"]}, {title: "Nee", shows_question: ["v4"]}]}
  ]);
  return (
